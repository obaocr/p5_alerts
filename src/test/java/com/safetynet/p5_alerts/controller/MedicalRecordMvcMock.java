...
public class MedicalRecordMvcMock {
	...
	void postPersonShouldReturnOK() throws Exception {
		...
		String personJSON = objectMapper.writeValueAsString(medicalRecord);
		//
		this.mockMvc.perform(post("/medicalrecord").contentType(MediaType.APPLICATION_JSON).content(personJSON))
	...
	void putPersonShouldReturnOK() throws Exception {
		...
		String personJSON = objectMapper.writeValueAsString(medicalRecord);
		//
		this.mockMvc.perform(put("/medicalrecord").contentType(MediaType.APPLICATION_JSON).content(personJSON))
				.andDo(print()).andExpect(status().isOk()).andReturn();
	}
	...
	void deletePersonShouldReturnOK() throws Exception {
		...
		String personJSON = objectMapper.writeValueAsString(medicalRecord);
		//
		this.mockMvc.perform(delete("/medicalrecord").contentType(MediaType.APPLICATION_JSON).content(personJSON))
				.andDo(print()).andExpect(status().isOk()).andReturn();
	}
}
